...
export function AdminCollections({
  ...
  return <main className="admin-page admin-collections-page">
    ...
    <section className="admin-collection-summary" aria-label="Collection overview">
      <div><strong>{generatedStats.total.toLocaleString()}</strong><span>Generated catalog pages</span><small>{navigationRows.length ? `${generatedStats.indexable.toLocaleString()} indexable · ${generatedStats.noindex.toLocaleString()} low-volume noindex` : catalogLoad.complete ? 'Calculated from the loaded catalogue' : 'Refreshing the deploy index…'}</small></div>
