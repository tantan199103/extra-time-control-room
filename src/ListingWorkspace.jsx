...
function PreviewRegionEditor({ field, image, onChange }) {
  ...
  const setRegion = patch => {
    const current = region || { x:35, y:35, width:30, height:15 }
