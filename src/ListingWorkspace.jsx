...
const seoBlockerLabels = {
  ...
  SEO_DESCRIPTION_120_160_CHARACTERS:'SEO description must be 120–160 characters',
  ...
  RIGHTS_REVIEW_REQUIRED:'Complete the rights and affiliation review'
}
...
function SeoReviewGatePanel({ draft, update }) {
  ...
  return <div className={`listing-subsection listing-seo-gate ${gate.ready ? 'is-ready' : 'is-blocked'}`}>
    <div className="listing-subsection__head"><div><span>INDEXING CONTROL</span><h3>SEO review gate</h3><p>Only a published, complete listing can enter the sitemap and Merchant feed. This status does not publish the product itself.</p></div><span className={`listing-merchant-status ${gate.ready ? 'is-ready' : 'is-blocked'}`}>{status}</span></div>
