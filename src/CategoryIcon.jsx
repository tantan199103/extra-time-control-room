...
export default function CategoryIcon({ kind = 'all', size = 20, className = '' }) {
  ...
  const Icon = ({ jersey:Shirt, custom:Sparkles, apparel:Layers3, accessories:Package, bag:Package, scarf:Layers3, drinkware:Package, matchday:Flag, socks:Layers3, gift:Sparkles, collectibles:Trophy, gear:Flag, all:Grid2X2 })[kind] || Grid2X2
