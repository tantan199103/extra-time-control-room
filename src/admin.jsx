...
import { fetchAdminProducts, fetchAdminTemplates, saveAdminProduct, saveAdminTemplate, supabaseConfigured } from './lib/supabase'
...
function AdminShell({ active, children, source, onRefresh }) {
  ...
  const items = [
    ...
    { id: 'catalog', label: 'Catalog', icon: Boxes, path: '/admin/catalog' },
