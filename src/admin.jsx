...
import { fetchAdminCollections, fetchAdminMenus, fetchAdminProducts, fetchAdminTheme, saveAdminCollections, saveAdminMenus, saveAdminProduct, saveAdminTheme, supabaseConfigured } from './lib/supabase'
...
function AdminWorkspace() {
  ...
  if (path === '/admin/catalog') page = <AdminCatalog products={productRows} onDuplicate={duplicateProduct} onBulkUpdate={bulkUpdateProducts}/>
