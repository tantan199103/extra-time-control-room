...
import { fetchAdminCollections, fetchAdminMenus, fetchAdminProducts, fetchAdminTheme, saveAdminCollections, saveAdminMenus, saveAdminTheme, supabaseConfigured } from './lib/supabase'
...
function CatalogRow({ product, onDuplicate }) {
...
function AdminWorkspace() {
  ...
  const active = isEditor || path === '/admin/catalog' ? 'catalog' : path.startsWith('/admin/theme/menus') ? 'menus' : path.startsWith('/admin/theme') ? 'theme' : path.startsWith('/admin/collections') ? 'collections' : path === '/admin/settings' ? 'settings' : 'overview'
  let page = <AdminOverview products={productRows}/>
  if (path === '/admin/catalog') page = <AdminCatalog products={productRows} onDuplicate={duplicateProduct}/>
